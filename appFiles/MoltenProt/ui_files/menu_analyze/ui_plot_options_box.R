box(title = "Plot options", width = 6, solidHeader = T, status = "primary", 
    fluidRow(
      ...
      conditionalPanel(condition = "input.show_plot_download_options_analyze",
        ...
        conditionalPanel("input.model_selected == 'EquilibriumTwoState'",
                         
                         column(4, p(HTML("</b>Fractions plot style</b>"),
                                     selectInput("fractions_plot_style", NULL,
                                                 c("markers",
                                                   "lines" ))))
      ...
      column(5, p(HTML("<b>Show Download Options</b>"),
