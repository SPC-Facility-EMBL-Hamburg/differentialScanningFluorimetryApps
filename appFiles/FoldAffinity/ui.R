  ...
  dashboardPage(
    ...
    dashboardBody(
      ...
      tabItems(
        ...
        tabItem(
          ...
          fluidRow(
            ...
            column(
              9,
              tabBox(
                title = "", width = 12, id = "tabset3",
                tabPanel("Isothermal Fitting", withSpinner(plotlyOutput("isf")))
              ),
        ...
        tabItem(
          tabName = "menu_simulate",
          fluidRow(
            source("ui_files/ui_kd_parameters_box.R",local = TRUE)$value,                  # input$dHb dCPb dSb Tb dHu
            source("ui_files/ui_ku_parameters_box.R",local = TRUE)$value,                  # input$dHu dCPu Tm
            box(
              title = "Protein and Ligand Params.", width = 2, solidHeader = T, status = "primary",
              fluidRow(
            ...
            source("ui_files/ui_fluo_dependence_on_temperature_box.R",local = TRUE)$value, # input$m1 m2 m3 b1 b2 b3
            source("ui_files/ui_equations.R",local = TRUE)$value
          )
        ),
        tabItem(
          tabName = "menu_export",
